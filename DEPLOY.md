...
| App path | `/home/ubuntu/encantotradecenter/etc_frontend` |
...
```bash
cd /home/ubuntu/encantotradecenter/etc_frontend
...
```bash
sudo cp /home/ubuntu/encantotradecenter/etc_frontend/deploy/etc-frontend.service /etc/systemd/system/
...
```bash
sudo cp /home/ubuntu/encantotradecenter/etc_frontend/deploy/nginx-encantotrade.mn.conf \
...
```
/home/ubuntu/encantotradecenter/etc_frontend/
