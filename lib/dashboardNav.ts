...
export const DASHBOARD_MANAGEMENT_GROUPS: DashboardMenuGroup[] = [
  ...
  },
  {
    ...
    path: "/dashboard/bms",
    items: [
      { key: "/dashboard/bms", label: "Dashboard", path: "/dashboard/bms" },
      { key: "/dashboard/bms/cameras", label: "Cameras", path: "/dashboard/bms/cameras" },
      { key: "/dashboard/bms/fire-alarms", label: "Fire Alarms", path: "/dashboard/bms/fire-alarms" },
      { key: "/dashboard/bms/elevator-access", label: "Elevator NFC", path: "/dashboard/bms/elevator-access" },
    ],
  },
  {
    key: "site-management",
