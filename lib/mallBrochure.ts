...
export const mallAdvantages = {
  ...
  title: "Why Encanto Trade Center Mall",
  items: [
    "Large-scale integrated retail environment in a prime district",
    "Strong and consistent customer flow",
    "Modern construction and engineering systems",
    "Synergized tenant structure",
    "Long-term value growth potential",
  ],
};

export const mallLeasingBrochure = {
  title: "Leasing Opportunities",
  body: "Retail spaces are available for lease. The project offers a structured environment designed to support long-term business growth and stable operations.",
  phones: ["9919-1522", "9404-8858"],
  emails: ["Khetbold@orgil.mn", "gantumur@orgil.mn"],
  brochurePdf: "/downloads/etc-mall-brochure.pdf",
};
