...
export const mn: Translations = {
  ...
  home: {
    hero: {
      tag: "Премиум оффис • Тансаг орон сууц • Дэлгүүр ба амьдралын хэв маяг",
      title: "Encanto",
      titleLine2: "Trade Center",
      subtitle:
        "Арилжаа, амьдралын хэв маяг, хөрөнгө оруулалт нэг дор нэгтсэн шинэ үеийн интеграцчилсан бизнесийн цогцолбор.",
      ctaPrimary: "Хувийн танилцуулга захиалах",
      ctaSecondary: "Төслийг судлах",
      scrollDown: "Доош гүйлгэх",
      scrollAria: "Доош гүйлгэн судлах",
    },
    brandStatement: {
      headline: "Хотын шинэ бэлгэ тэмдэг.",
    ...
    about: {
      ...
      body: "Grade-A оффис, тансаг орон сууц, premium худалдаа үйлчилгээ, ресторан болон амьдралын тав тухыг бүрэн хангасан орчныг санал болгоно.",
    ...
    construction: {
      ...
      title: "2026 оны 4-р улиралд ашиглалтад орно.",
      lead: "Оффис, молл, Ballroom, орон сууц 2026 оны намраас нээгдэхээр төлөвлөгдсөн.",
      timeline: [
        {
          period: "2026 IV улирал",
          tower: "Оффис",
          detail: "Премиум оффисын давхрууд 2026 оны намраас ашиглалтад орно.",
        },
        {
          period: "2026 IV улирал",
          tower: "Молл",
          detail: "Дэлгүүр, ресторанууд 2026 оны намраас нээгдэнэ.",
        },
        {
          period: "2026 IV улирал",
          tower: "Ballroom",
          detail: "Grand Ballroom болон арга хэмжээний танхимууд 2026 оны намраас бэлэн.",
        },
        {
          period: "2026 IV улирал",
          tower: "Орон сууц",
          detail: "2026 IV улирал ашиглалтад орно.",
        },
      ],
    },
    whyEncanto: {
    ...
    floorPlans: {
      eyebrow: "Давхрын төлөвлөгөө",
      title: "Цуглуулгыг судлах.",
      tabs: [
        { id: "office", label: "Оффис" },
        { id: "mall", label: "Молл" },
        { id: "residence", label: "Орон сууц" },
      ],
      downloadPdf: "Давхрын төлөвлөгөө татах",
      imageAlt: "давхрын төлөвлөгөө",
    },
    amenities: {
      eyebrow: "Тав тух",
      title: "Сонгосон амьдралын хэв маяг.",
      ariaLabel: "Тав тухын зураг",
      items: [
        { title: "Тансаг лобби" },
        { title: "Тэнгэрийн цэцэрлэг" },
        { title: "Фитнесс" },
        ...
        { title: "Ухаалаг нэвтрэлт" },
      ],
    },
    gallery: {
      eyebrow: "Зургийн цомог",
      title: "Encanto-гийн дүр зураг.",
      items: [
        { title: "Зураглал" },
    ...
    news: {
      ...
      title: "Encanto-гийн мэдээлэл.",
      headerNote: "Төслийн онцлох мэдээ болон сүүлийн зар мэдээлэл.",
    },
    contact: {
      eyebrow: "Холбоо барих",
      title: "Хувийн танилцуулга захиалах",
      lead: "Борлуулалтын багтай уулзаж оффис, орон сууц, дэлгүүр, хөрөнгө оруулалтын боломжуудыг судлаарай.",
      formTitle: "Хүсэлт илгээх",
      formLead:
        "Сонирхож буй чиглэл, хугацаа эсвэл асуултаа үлдээнэ үү. Бид ажлын 1 өдрийн дотор хариу өгнө.",
      salesTeam: "Борлуулалтын баг",
      alsoAvailable: "Мөн холбогдох",
      ...
      interestOptions: [
        ...
        { value: "mall", label: "Дэлгүүр" },
        { value: "general", label: "Хөрөнгө оруулалт" },
      ],
    },
    floatingActions: {
    ...
    interactiveBuilding: {
      ...
      lead: "Барилгын гадна зураг дээр хулганаа байрлуулж оффис, худалдаа үйлчилгээ, Ballroom, Encanto Tower, орон сууц болон бусад хэсгүүдийн мэдээллийг хараарай.",
