...
export const mallEn: MallTranslations = {
  explore: {
    eyebrow: "Project",
  ...
  hero: {
    ...
    primaryCta: "Explore Mall",
    secondaryCta: "Floor Plan",
    tertiaryCta: "Contact",
  },
  intro: {
    ...
    imageAlt: "Encanto Trade Center exterior at dusk with illuminated retail podium and towers",
    stats: [
      { value: "23,707", unit: "sqm", label: "Total mall area" },
      { value: "55,682", unit: "sqm", label: "Connected retail space" },
  ...
  tenantSection: {
    ...
    categoriesLabel: "Tenant categories",
    categories: [
    ...
    outcomes: ["Increased foot traffic", "Longer customer dwell time", "Improved sales performance"],
    imageAlt: "Mall tenant composition",
  },
  layoutSection: {
    ...
    features: [
      "5-meter ceiling height providing spacious interiors",
      "Hypermarket located on B1–B2 levels",
      "Clearly zoned dining and service areas",
    ],
    imageAlt: "Mall layout and circulation",
  },
  highlightsSection: {
  ...
  locationSection: {
    ...
    points: [
      "Located in a prime, high-value district",
      "Direct bridge connections to retail and sports complexes",
      "400 dedicated parking spaces",
    ],
    landmarks: [
      { name: "Shangri-La Center", note: "Prime district landmark" },
      { name: "Olympic Bridge", note: "City connectivity" },
      { name: "Encanto Trade Center", note: "Integrated destination" },
    ],
    address: "Bayanzurkh District, 26th Khoroo, Encanto Town, Ulaanbaatar, Mongolia",
    imageAlt: "Mall location and connectivity",
    getDirections: "Get Directions",
  },
  floorPlanActions: {
    downloadFloorPlan: "Download Floor Plan",
    downloadBrochure: "Download Brochure",
    requestLeasing: "Request Leasing Info",
  },
  leasing: {
    ...
    primary: "Lease a Space",
    secondary: "Download Brochure",
    tertiary: "Contact Leasing Team",
  },
  contact: {
    title: "Get in Touch",
  ...
  faqSection: { eyebrow: "FAQ", title: "Leasing & Visitor Questions" },
  faq: [
    {
