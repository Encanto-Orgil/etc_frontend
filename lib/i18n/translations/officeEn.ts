...
export const officeEn: OfficeTranslations = {
  ...
  contact: {
    eyebrow: "Contact",
    title: "Schedule a Private Office Presentation",
    lead: "Connect with our sales team for availability, pricing, floor plans, and guided tours of Grade-A office spaces at Encanto Trade Center.",
    formTitle: "Send an inquiry",
    formLead: "Tell us your preferred floor size, move-in timeline, or questions. We respond within one business day.",
